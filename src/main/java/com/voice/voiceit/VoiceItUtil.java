...
public class VoiceItUtil {
	...
	public VoiceItUtil(String apiKey, String apiToken){
			HttpClientBuilder clientBuilder = HttpClientBuilder.create();
			setup(clientBuilder, apiKey, apiToken);
			httpClient = clientBuilder.build();
	}

	public VoiceItUtil(String apiKey, String apiToken, String customBaseURL) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException{
